...
public class DuplicateLead extends BaseClass{
	...
	@Test(enabled= true,dataProvider="duplicateLead")
	...
	private String[][] duplicateLead() throws IOException {
		
		String[][] duplicateLead = ReadExcelFileDataDuplicateLead.duplicateLead();
